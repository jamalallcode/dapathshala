...
export default function LandingPage() {
  ...
  // View state: 'landing' (public page) | 'login' (step-by-step login flow)
  ...
  // New Modals for exact sidebar items
  ...
  // Institution State
  const [registeredInstitution, setRegisteredInstitution] = useState<any>(null);
  ...
  // If user is viewing public landing page (with 2026 NCTB banner & preview)
  if (viewMode === 'landing') {
    return (
  ...
  // If user is in the step-by-step Google login flow (Images 1-5)
  if (viewMode === 'login') {
    return (
      <div className="relative min-h-screen bg-[#f1f5f9]">
        <LoginPageView
  ...
  return (
    <div className="w-full bg-[#f8fafc] text-slate-800 font-['Hind_Siliguri'] overflow-x-hidden relative min-h-screen">
      ...
      <div className="p-3 sm:p-6 md:p-8 space-y-6 max-w-7xl w-full mx-auto overflow-x-hidden min-w-0">
          ...
          <div className="bg-white rounded-2xl p-5 sm:p-7 border border-slate-200/80 shadow-xs">
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 justify-items-center">
              ...
              >
                <div className="w-22 h-22 sm:w-26 sm:h-26 rounded-full bg-gradient-to-br from-teal-50 to-emerald-50 border border-teal-200/70 shadow-xs flex items-center justify-center group-hover:scale-105 group-hover:shadow-md group-hover:border-teal-300 transition-all duration-300 relative overflow-hidden">
                  <svg width="52" height="52" viewBox="0 0 72 72" fill="none" className="text-teal-600 drop-shadow-xs">
                ...
                <span className="mt-3 text-sm font-bold text-slate-700 group-hover:text-teal-700 transition">
                  প্রশ্ন তৈরি
                </span>
              </div>
              ...
              <div 
                ...
                className="flex flex-col items-center group cursor-pointer"
              >
                <div className="w-22 h-22 sm:w-26 sm:h-26 rounded-full bg-gradient-to-br from-rose-50 to-orange-50 border border-rose-200/70 shadow-xs flex items-center justify-center group-hover:scale-105 group-hover:shadow-md group-hover:border-rose-300 transition-all duration-300 relative overflow-hidden">
                  <svg width="52" height="52" viewBox="0 0 72 72" fill="none" className="drop-shadow-xs">
                    {/* OMR Sheet behind */}
                    ...
                    <circle cx="20" cy="48" r="1.5" fill="#f43f5e" />
                    <circle cx="25" cy="48" r="1.5" stroke="#cbd5e1" />
                    {/* Scanner Smartphone in front */}
                ...
                <span className="mt-3 text-sm font-bold text-slate-700 group-hover:text-rose-700 transition">
                  OMR Evaluator
                </span>
              </div>
              ...
              <div 
                ...
                className="flex flex-col items-center group cursor-pointer"
              >
                <div className="w-22 h-22 sm:w-26 sm:h-26 rounded-full bg-gradient-to-br from-cyan-50 to-blue-50 border border-cyan-200/70 shadow-xs flex items-center justify-center group-hover:scale-105 group-hover:shadow-md group-hover:border-cyan-300 transition-all duration-300 relative overflow-hidden">
                  <svg width="52" height="52" viewBox="0 0 72 72" fill="none" className="drop-shadow-xs">
                    {/* Laptop Screen */}
                    ...
                    <rect x="20" y="35" width="14" height="3" rx="1" fill="#e0f2fe" />
                    {/* Clock / Timer Overlay */}
                ...
                <span className="mt-3 text-sm font-bold text-slate-700 group-hover:text-cyan-700 transition">
                  অনলাইন পরীক্ষা
                </span>
              </div>
              ...
              <div 
                ...
                className="flex flex-col items-center group cursor-pointer"
              >
                <div className="w-22 h-22 sm:w-26 sm:h-26 rounded-full bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-200/70 shadow-xs flex items-center justify-center group-hover:scale-105 group-hover:shadow-md group-hover:border-purple-300 transition-all duration-300 relative overflow-hidden">
                  <svg width="52" height="52" viewBox="0 0 72 72" fill="none" className="text-purple-600 drop-shadow-xs">
                ...
                <span className="mt-3 text-sm font-bold text-slate-700 group-hover:text-purple-700 transition">
                  স্মার্টবোর্ড
                </span>
              </div>
              ...
              <div 
                ...
                className="flex flex-col items-center group cursor-pointer"
              >
                <div className="w-22 h-22 sm:w-26 sm:h-26 rounded-full bg-gradient-to-br from-rose-50 to-pink-50 border border-rose-200/70 shadow-xs flex items-center justify-center group-hover:scale-105 group-hover:shadow-md group-hover:border-rose-300 transition-all duration-300 relative overflow-hidden">
                  <svg width="52" height="52" viewBox="0 0 72 72" fill="none" className="drop-shadow-xs">
                    ...
                    <line x1="43" y1="46" x2="43" y2="49" stroke="#713f12" strokeWidth="1.5" />
                  </svg>
                </div>
                <span className="mt-3 text-sm font-bold text-slate-700 group-hover:text-rose-700 transition">
                  PDF Protect
              ...
              <div 
                ...
                className="flex flex-col items-center group cursor-pointer"
              >
                <div className="w-22 h-22 sm:w-26 sm:h-26 rounded-full bg-gradient-to-br from-indigo-50 to-blue-50 border border-indigo-200/70 shadow-xs flex items-center justify-center group-hover:scale-105 group-hover:shadow-md group-hover:border-indigo-300 transition-all duration-300 relative overflow-hidden">
                  <svg width="52" height="52" viewBox="0 0 72 72" fill="none" className="drop-shadow-xs">
                    ...
                    <line x1="16" y1="38" x2="26" y2="38" stroke="#93c5fd" strokeWidth="1.5" strokeLinecap="round" />
                    ...
                    <line x1="42" y1="36" x2="48" y2="36" stroke="#bfdbfe" strokeWidth="1.5" strokeLinecap="round" />
                  </svg>
                </div>
                <span className="mt-3 text-sm font-bold text-slate-700 group-hover:text-indigo-700 transition">
                  PDF to Booklet
                </span>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 min-w-0">
            ...
            <div className="bg-white rounded-2xl p-6 sm:p-7 border border-slate-200/80 shadow-xs flex flex-col justify-between">
              <div>
                ...
                {/* Channel Notice Box matching Image 2 text */}
                ...
                {/* Notice Bullet List matching Image 2 */}
                <div className="space-y-3">
                  <div className="flex items-center gap-3 text-xs sm:text-sm text-slate-700 font-medium hover:text-slate-900 cursor-pointer">
                    <span className="text-base">🚀</span>
                    <span>নতুন ফিচার আপডেট</span>
                  </div>

                  <div className="flex items-center gap-3 text-xs sm:text-sm text-slate-700 font-medium hover:text-slate-900 cursor-pointer">
                    <span className="text-base">📢</span>
                    <span>গুরুত্বপূর্ণ ঘোষণা</span>
                  </div>
      ...
      {/* =========================================================================
          3. REGISTRATION POPUP MODAL
          Matches the exact green-header modal in the user's screenshot:
